...
const ACTIONS: [&'static str; 76] = ["amuses",
                                     "avoids",
                                     "berates",
                                     "boggles",
                                     "bothers",
                                     ...
                                     "alters",
                                     "intimidates"];
const ADJECTIVES: [&'static str; 168] = ["23rd",
                                         "acceptable",
                                         "acrobatic",
                                         "alien",
                                         "amiable",
                                         ...
                                         "upgraded",
                                         "Mayan"];
// const INTROS: [&'static str; 34] = ["4 out of 5 dentists recommend that",
...
// "Warning!",
// "We suspect that"];
const NAMES: [&'static str; 148] = ["007",
                                    "a dead relative",
                                    "a long-lost uncle",
                                    "a dead rock star",
                                    "Abdul Al-Azrad",
                                    ...
                                    "the Dixie Chicks",
                                    "the Powerpuff Girls"];
const NOUNS: [&'static str; 192] = ["911 file",
                                    "(censored)",
                                    "amethyst",
                                    "amulet",
                                    "ash tray",
                                    ...
                                    "laptop",
                                    "nanite"];
const PLACES: [&'static str; 94] = ["(not available at your clearance)",
                                    "Afghanistan",
                                    "Alpha Centauri",
                                    "Alpha Complex",
                                    "Atlantis",
                                    ...
                                    "Smallville",
                                    "the Shire"];
const PREPOSITIONS: [&'static str; 102] = ["assumes responsibility for",
                                           "avoids servants of",
                                           "deals with",
                                           "elopes with",
                                           "evades agents of",
...
const PRONOUNS: [&'static str; 6] = ["his", "my", "our", "the", "your", "their"];

fn action() -> &'static str {
    rand::thread_rng().choose(&ACTIONS).unwrap()
}
fn adjective() -> &'static str {
    rand::thread_rng().choose(&ADJECTIVES).unwrap()
}
// fn intro() -> &'static str {
// rand::thread_rng().choose(&INTROS).unwrap()
// }
fn name() -> &'static str {
...
fn place() -> &'static str {
    rand::thread_rng().choose(&PLACES).unwrap()
}
fn preposition() -> &'static str {
    rand::thread_rng().choose(&PREPOSITIONS).unwrap()
}
